...
In the case of a redundant array we can not only solve for the gains $\bg$ but also the redundant visibilities $\by$ themselves. Where $\by = [y_1,\cdots,y_R]$, $y_i$ denotes 
