...
We present the Signal-to-noise ratio definition we used in this paper in Section\ref{sec:snr}. The general scope and limitations of this paper is discussed in Section~\ref{sec:scope}.
