...
The above formulation is valid and is in fact equivalent to the real/imaginary formulation from above, since v breve is analytic in its argument and its complex conjugate as a whole if we use the Wirtinger derivative
to define our gradient operator.
