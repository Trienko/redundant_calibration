...
\caption{In the top panel we have three different redundant antenna layouts. In the bottom panel we have the symmetric redundancy geometry mapping $\zeta_{ij}$
of each of the layouts in the top panel.}
\end{figure*}
