...
\end{cases}.
\end{equation} 
It is possible to construct a simple analytic expression for $\zeta_{ij}$ when our array is in an east-west regular configuration: $\zeta_{ij} = |j-i|$. 
...
the hexagonal, square and east-west layouts which are depicted in the top panel are 165, 180 and 99 respectively.\label{fig:geometry_function}}
\end{figure*}
