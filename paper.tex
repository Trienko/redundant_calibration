...
\begin{table}
\centering
\caption{We generated results using two major simulation setups. We either used one frequency channel and multiple time-slots, or one time-slot and many frequency 
