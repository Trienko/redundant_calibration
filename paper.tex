...
As mentioned in Section We use Eq.~\eqref{eq:GN_update} or Eq.~\eqref{eq:LM_update} to iteratively update our 
...
\section{Redundant Wirtinger Calibration - $\bJ$ and $\bH$}
\label{sec:analytic}
