...
We use a similar approach to the diagonal approximate method proposed in \citet{Smirnov2015} to show that the ADI algorithm presented in \citet{Marthi2014} is in fact redundant 
StEfCal.
