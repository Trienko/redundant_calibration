...
The most standard way of tackling the calibration problem is to treat the real and imaginary parts of the residual (difference between observed and predicted visibilities) separately and then to independantly solve for the real and imaginary parts
of the gains. \citet{Smirnov2015} have recently shown that calibration can be performed using complex optimization framework. The main difference between the traditional approach and the 
complex optimization framework proposed by \citet{Smirnov2015} is that we no longer treat the real and imaginary parts of the residual separately which enables us to directly solve for the complex antenna gains (and their
complex conjugate). The main reason why we can  
