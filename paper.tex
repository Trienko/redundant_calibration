...
If an array is redundant its redundant baselines sample the exact same visibilites in the $uv$-plane. So even though we label the visibilies belonging to different redundant baselines with
