...
independent of the problem size (the number of antennas in the array). The fact that $\kappa$ is small and independent of problem size implies that it simply drops out 
...
method. The right hand panel shows us that the number of major iterations needed by the preconditioned conjugate gradient method to invert $\bH$ is much smaller than the 
dimension of $\bH$ and is independent of the problem size (the number of antennas in the array). 
\label{fig:sup_anti}} 
\end{figure*}
