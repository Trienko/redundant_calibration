...
\begin{table*}
\centering
\caption{The following fixed simulation parameters were used to generate the results of this paper. The units of the last column are in degrees.}
\begin{tabular}{|c c c c c c c|} 
\hline
Declination & Latitude & Minimum baseline & Geometry& Sources & Flux & Spatial \\
\hline 
\hline
$-30^{\circ}43'17.34''$ & $-74^{\circ}39'37.481''$ & 20 & Hexagonal &100 & Pareto (shape param. of 2) & $U[-3,3]$ 
\end{tabular}
\end{table*}

\begin{table*}
\centering
\caption{The gain error models used in this paper. We have used the symbol $x$ here as a proxy as it can either refer to $t$ or $\nu$. We either
...
\hline
Number tag & 1 & 2 & 3\\
Model & Sinusoidal amplitude and phase & Sinusoidal real and imaginary parts & Phase slope \\ [0.5ex] 
\hline\hline
...
Parameters & $A=a\cos(2\pi fx +b)$  & $f=5$ & $P=\tau x$ \\
 ...
 & $f=5$ & $B,D\sim U[0,2\pi]$ &  $l\sim U[5,50]$\\
 & $a\sim U[0.8,0.9]$ &  & \\ 
 & $c\sim U[0.5,5]$ &  &  \\ 
 & $b,d\sim U[0,2\pi]$ &  &  \\ 
\hline
