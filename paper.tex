...
\citep{Sluis1986}. As can be seen from Algorithm \ref{algo:CG}, the CG method makes use of only one major outer loop. It turns out that in the worst possible case 
the number of major iterations that is required by CG to converge is proportional to $\sqrt{\kappa}$.
