...
Recall that we mentioned that in general we can only solve Eq.~\eqref{eq:linear_system} with CG if $\bA$ is a square positive-definite Hermitian matrix. Recently,
...
square matrix as long as $\bb$ is in the column range of $\bA$.
