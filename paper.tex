...
\begin{eqnarray}
 ...
 \bv &=& [g_p y_{\phi_{pq}} \conj{g}_q]  \big \} ~ [pq] = 1\cdots N ~ (p<q),\nonumber\\
 \bn &=& [n_{pq}]  \big \} ~ [pq] = 1\cdots N ~ (p<q).\label{eq:vec_definitions}
\end{eqnarray}
In Eq.~\eqref{eq:vec_definitions}, $N$ denotes the number of antennas in the array. NB --- above equation is wrong, needs to be baselines ...
