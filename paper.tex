...
\begin{enumerate}
 ...
 \end{equation}
 In Eq... $y_{pq}$ denotes the synthetic visibility which was generated by 
...
of the gains. \citet{Smirnov2015} have recently shown that calibration can be performed using a complex optimization framework. The main difference between the traditional approach and the 
...
complex conjugates). Recall that most optimization techniques require a gradient operator to enable it to function properly. The main reason why we have traditionally treated 
