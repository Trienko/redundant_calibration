...
Redundant calibration was already in use in the 1980's. \citet{Noordam1982} used redundant calibration and the WSRT (Westerbork Synthesis Radio Telescope) to produce high-dynamic range images of 3C84.
...
the true observed visibilities \citep{Wijnholds2012,Marthi2014}. The second is to use the preconditioned conjugate gradthient (PCG) method. PCG allows us to exploit the sparsity inherent in the redundant calibration problem, 
...
Layered approach, LOGCAL, \textsc{lincal}, Stefan's conference paper, Noordam, other ASTRON paper, newest papers on redundant calibration, marthi paper etc...
