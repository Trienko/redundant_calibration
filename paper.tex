...
of calibration from $\mathbb{O}(N^3)$ to $\mathbb{O}(N^3)$, where $N$ denotes the number of antennas in the array. The second is to not break the calibration problem 
