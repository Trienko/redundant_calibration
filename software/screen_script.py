...
if __name__ == "__main__":
   ...
   screen_func(SNR=1000,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD") 
   screen_func(SNR=20,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")
   screen_func(SNR=10,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")
   screen_func(SNR=5,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")
   screen_func(SNR=3,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")
   screen_func(SNR=1,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")
   screen_func(SNR=0,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD")  
   screen_func(SNR=-1,method="RSteFCal",min_order=1,max_order=8,layout="HEX",time_var=True,exp_num=3,freq_on=True,type_gain="G_OLD") 
