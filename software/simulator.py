...
class sim():
      ...
      def __init__(self,h_min=-1,h_max=1,dec=(-74-39./60-37.481/3600)*(np.pi/180),lat=(-30 - 43.0/60.0 - 17.34/3600)*(np.pi/180),freq=150*10**6,layout="HEX",nsteps=600,bas_len=50,order=1,seed=1):
          self.h_min = h_min
          self.h_max = h_max
          self.nsteps = nsteps
      ...
      def plot_ant(self,title="KAT",label_size=14,ms=10):
          ...
          plt.title(title+"-100",fontsize=label_size)
          plt.axis("equal")
